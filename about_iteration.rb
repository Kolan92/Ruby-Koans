...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # In other programming lanuguages the method is called agregate or reduce
  end
  ...
  # To dispose handler to dile after file usage. It's done autmaticly in code block.
  # In the second file need to be closed with file.close in enusre block
